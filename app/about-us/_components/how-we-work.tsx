...
export default function HowWeWork() {
    ...
    return (
        <div className="min-h-screen relative">
            <img src="/bg-elements2.jpg" alt="bg-elements-2" className="absolute inset-0 -z-10" />
            {/* Process Steps */}
            <section className="py-28 px-4 bg-white/50">
                        ...
                        {processSteps.map((step, index) => (
                            ...
                            >
                                <CardHeader className="text-center">
                                    ...
                                    <div className="absolute z-10 -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center">
                                ...
                                <BorderBeam duration={10} size={150} colorFrom={`#63b3ed`} delay={10} />
                            </Card>
                        ))}
                    </div>
                </div>
            ...
            <div className="relative w-full h-full">
                <img src="/bg-elements3.jpg" alt="bg-elements-3" className="absolute inset-0 -z-10 opacity-50" />
